 ...
 */
function internalMix(state: bigint[]): bigint[] {
 ...
 */
function externalMix(state: bigint[]): bigint[] {
 ...
 */
export function poseidon2Hash(inputs: bigint[], len: number = inputs.length): bigint {
 ...
 */
export function deriveNotePubKey(sharedX: bigint, sharedY: bigint): bigint {
 ...
 */
export function computeNullifierV2(spendingPriv: bigint, leafIndex: bigint): bigint {
 ...
 */
export function computeCommitmentV1(
  nullifier: bigint,
  secret: bigint,
  amount: bigint
): bigint {
 ...
 */
export function computeNullifierHashV1(nullifier: bigint): bigint {
  return poseidon2Hash([nullifier], 1);
}
