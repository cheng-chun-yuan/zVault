 ...
 */
export function computeCommitment(note: NoteData | Note): bigint {
  throw new Error(
    "computeCommitment is not available in Noir mode. " +
...
export function computeNullifierHash(nullifier: bigint): bigint {
  throw new Error(
    "computeNullifierHash is not available in Noir mode. " +
