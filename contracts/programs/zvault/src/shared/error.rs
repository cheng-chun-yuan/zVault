...
//!
//! Custom error codes starting at 6000 to avoid conflicts with system errors.
//! Error ranges are organized by category for easier debugging:
//!
//! - 6000-6039: Core operation errors
//! - 6040-6059: Yield pool errors
//! - 6060-6069: Security validation errors
...
pub enum ZVaultError {
    // =========================================================================
    // Core Operation Errors (6000-6039)
    // =========================================================================
...
mod tests {
    ...
    #[test]
    fn test_error_codes_in_expected_ranges() {
        // Core errors: 6000-6039
        assert_eq!(ZVaultError::PoolPaused as u32, 6000);
        assert_eq!(ZVaultError::InsufficientFunds as u32, 6030);

        // Yield pool errors: 6040-6059
        assert_eq!(ZVaultError::YieldPoolPaused as u32, 6040);
        assert_eq!(ZVaultError::InvalidPositionCommitment as u32, 6049);
    ...
    fn test_error_to_program_error() {
        let err: ProgramError = ZVaultError::PoolPaused.into();
